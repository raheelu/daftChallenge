...
# Diagonal placement for visual appeal
pgm.add_node("lemons", "Lemons", 1, 1.6, aspect=3, scale=1.1,
             plot_params={
...
pgm.add_node("no_scurvy", "No\nScurvy", 3.5, 0.8, aspect=3, scale=1.1,
             plot_params={
...
plt.suptitle("James Lind (1747): Correct but Incomplete",
             fontsize=13, weight="bold", style="italic", y=0.97)
...
# Diagonal node placement (top-left → bottom-right)
pgm.add_node("acid", "Acid", 0.8, 1.8, aspect=3, scale=1.1,
             plot_params={
...
pgm.add_node("bacteria", "Bacteria\nDeath", 2.4, 1.2, aspect=3, scale=1.1,
             plot_params={
...
pgm.add_node("no_scurvy", "No\nScurvy", 4.0, 0.6, aspect=3, scale=1.1,
             plot_params={
                 'facecolor': 'lightgreen',   # Healthy green
                 'edgecolor': 'darkgreen',    # Strong green border
                 'linewidth': 2,
...
plt.suptitle("The Misguided Belief (1800s)",
             fontsize=13, weight="bold", style="italic", color='darkred', y=0.97)
plt.title("Acid kills bacteria → WRONG understanding caused scurvy to return",
          fontsize=9.5, style="italic", color='darkred', pad=10)
...
# Diagonal placement for consistency
pgm.add_node("vitamin_c", "Vitamin C", 1, 1.6, aspect=3, scale=1.1,
             plot_params={
...
plt.suptitle("The Complete Understanding (1928)",
             fontsize=13, weight="bold", style="italic", color='darkblue', y=0.97)
plt.title("Vitamin C deficiency causes scurvy → explains all earlier observations",
          fontsize=9.5, style="italic", color='darkblue', pad=10)
